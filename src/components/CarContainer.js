      ...
      <div className='flex flex-no-wrap'>
        ...
        <div className='absolute flex-col justify-between hidden min-h-screen shadow w-84 sm:relative bg-white-200 md:h-full sm:flex'>
          <div className='px-8 py-8 '>
            ...
            <ul className='mt-12 '>
              <li className='flex items-center justify-between w-full mb-6 text-gray-300 cursor-pointer hover:text-lime-700' />
              <li className='flex items-center justify-center mb-6 text-gray-600 cursor-pointer hover:text-lime-700'>
                <div className='flex items-center text-gray-900 bg-white border border-gray-200 focus:outline-none hover:bg-lime-700 focus:ring-4 focus:ring-lime-700 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-lime-600 dark:text-gray-700 dark:border-gray-200 dark:hover:bg-gray-200 dark:hover:border-gray-100 dark:focus:ring-gray-300'>
              ...
              <li className=' w-full justify-between cursor-pointer item-center flex items-center text-gray-900 bg-white border border-gray-200 focus:outline-none hover:bg-lime-600 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-300 dark:text-gray-700 dark:border-gray-200 dark:hover:bg-gray-200 dark:hover:border-gray-100 dark:focus:ring-gray-300'>
