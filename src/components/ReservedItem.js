    ...
    <section className="fixed top-0 w-full h-full md:pl-[20vw] bg-[url('/src/assets/reserveCar.jpg')] bg-no-repeat bg-200%">
      <div className="w-full h-full bg-[#32CD32]/70 px-20 flex flex-col justify-center">
        <div className="w-full h-[50%] text-center flex flex-col justify-center items-center gap-[2rem]">
          ...
          {formSubmitted && (
            <div className="bg-#32CD32-100 border border-orange-400 text-#32CD32-700 px-4 py-3 rounded fixed top-4" role="alert">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[2rem]">
            ...
            <select name="car_id" id="car_id" className="bg-white border border-gray-400 rounded-lg py-2 px-4 block w-full">
              {names.map((el) => (
