...
const CarDetails = () => {
  ...
  const fetchCar = async () => {
    const res = await fetch(
      `https://africar-premium.herokuapp.com/api/v1/cars/${id}`
    );
  ...
  return (
    <section className='car'>
      ...
      <div className='flex flex-no-wrap'>
        ...
        <div className='w-11/12 h-full bg-white px-6 py-10 mx-auto  md:w-4/5 car-details- '>
          <article key={car.id} className='flex h-full'>
            <div className='m-2  flex items-center w-full'>
              <img
                src={car.picture}
                className='border rounded object-cover w-3xl'
              />
            </div>
            <div className='w-full h-8/12 p-10'>
              <table>
                <tr>
                  <th className='text-xl font-bold text-gray-700 '>
                    <h1>{car.name}</h1>
                    <small className='text-gray-700 m-2 flex justify-end font-semibold'>
                      &copy; 2022 africar.com, all right reserved
                    </small>
                  </th>
                </tr>
                <tr>
                ...
                <tr>
                  <td className='flex justify-end'>Duration: 48 months</td>
                </tr>
                <tr>
                  <td className=''>
                    <img src={ChartStat} alt='chart'/>
                  </td>
                </tr>
              </table>
              <Link to='/reserveform'>
                <button
                  type='button'
                  className='text-white bg-[#9FBD3B]/100 hover:bg-[#9FBD3B]/70 focus:ring-4 focus:outline-none focus:ring-lime-300 font-medium text-sm px-5 py-3.5 rounded-full text-center inline-flex items-center dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800 my-4'
                >
